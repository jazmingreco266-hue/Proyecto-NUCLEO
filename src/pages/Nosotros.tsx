...
export default function Nosotros() {
  return (
    <div>
      ...
      <Card className="mb-6 bg-gradient-to-br from-lavender-50 to-teal-50">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-lavender-600">
            <Heart size={20} />
          </div>
          <div>
            <h2 className="font-display text-lg font-bold text-ink-900">Una carta, antes que nada</h2>
            ...
            <p className="mt-4 text-sm font-bold text-lavender-600">Con cariño, el equipo de Núcleo.</p>
          </div>
        </div>
      </Card>

      <div className="grid gap-5 sm:grid-cols-2">
        <Card className="bg-gradient-to-br from-lavender-500 to-teal-500 text-white">
        ...
        <Card>
          ...
          <h3 className="font-display text-lg font-bold text-ink-900">Visión</h3>
      ...
      <Card className="mt-6">
        <h3 className="font-display text-lg font-bold text-ink-900">Nuestros principios</h3>
